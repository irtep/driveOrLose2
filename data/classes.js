...
export class AllRects {
  ...
  setCorners(angle) {
    ...
    this.leftTopCorner = getRotatedTopLeftCornerOfRect(
      this.x,
      this.y,
      this.w,
      this.h,
    ...
    this.rightTopCorner = getRotatedTopLeftCornerOfRect(
      this.x,
      this.y,
      this.w,
      this.h,
    ...
    //console.log('angle: ',angle);
    this.rightBottomCorner = getRotatedTopLeftCornerOfRect(
      this.x,
      this.y,
      this.w,
      this.h,
    ...
    angle = angle + getAngleForNextCorner(this.w / 2, vecLength);
    //console.log('angle: ',angle);
    this.leftBottomCorner = getRotatedTopLeftCornerOfRect(
      this.x,
      this.y,
      this.w,
      this.h,
...
export class TestBar extends AllRects {
...
export class ArcObstacle {
  constructor(x, y, a, aS, aE, color) {
    this.x = x;
    this.y = y;
    (this.a = a), (this.color = color);
    this.weight = 50;
...
export class Car extends AllRects {
...
*/
export class CheckPoint extends AllRects {
